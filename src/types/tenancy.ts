...
export interface OrganizationChartPerson { id: string; employeeCode: string; fullName: string; positionName: string; isPrimary: boolean; rank: number; username: string | null; email: string | null; }
