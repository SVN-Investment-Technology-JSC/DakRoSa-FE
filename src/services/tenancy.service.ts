...
export const tenancyService = {
  ...
  updateOrganizationUnit: (id: string, input: Partial<CreateOrganizationUnitInput>) => apiRequest<void>(`/tenancy/organization/units/${id}`, { method: 'PATCH', body: JSON.stringify(input) }),
  deleteOrganizationUnit: (id: string) => apiRequest<void>(`/tenancy/organization/units/${id}`, { method: 'DELETE' }),
  ...
  updateOrganizationPosition: (id: string, input: Partial<CreatePositionInput>) => apiRequest<void>(`/tenancy/organization/positions/${id}`, { method: 'PATCH', body: JSON.stringify(input) }),
  deleteOrganizationPosition: (id: string) => apiRequest<void>(`/tenancy/organization/positions/${id}`, { method: 'DELETE' }),
  ...
  createAndAssignPersonnel: (input: CreateAndAssignPersonnelInput) => apiRequest<void>('/tenancy/organization/personnel/appoint', { method: 'POST', body: JSON.stringify(input) }),
