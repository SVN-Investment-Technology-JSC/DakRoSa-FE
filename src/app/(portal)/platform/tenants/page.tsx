...
export default function PlatformTenantsPage() {
  ...
  const createTenant = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      event.currentTarget.reset(); setSelectedId(created.id); setInitialAdmin(created.initialAdmin); setMessage('Đã tạo doanh nghiệp và tài khoản quản trị doanh nghiệp. Hãy lưu mật khẩu ban đầu ngay bây giờ.'); await loadTenants();
