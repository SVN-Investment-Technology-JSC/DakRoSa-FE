...
export function SubmissionsPage({ tenantSlug }: { tenantSlug: string }) {
  ...
  const fetchSubmissions = useCallback(
    (nextSearch = '', nextStatus: SubmissionStatus | '' = '') => eOfficeService.getSubmissions({ search: nextSearch, status: nextStatus }),
    [],
  );

  const load = useCallback(async (nextSearch = '', nextStatus: SubmissionStatus | '' = '') => {
    try {
